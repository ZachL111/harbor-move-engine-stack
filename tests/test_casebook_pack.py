"""Regression checks for the harbor-move-engine-stack casebook."""
...
from casebook.harness import assert_expected, harbor_move_engine_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(harbor_move_engine_stack_summary(), assert_expected())
